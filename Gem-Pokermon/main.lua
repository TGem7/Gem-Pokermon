...
table.insert(family, {"treecko", "grovyle", "sceptile", "mega_sceptile"})
table.insert(family, {"torchic, combusken, blaziken"})
table.insert(family, {"mudkip, marshtomp, swampert"})
table.insert(family, {"mawile", "mega_mawile"})
