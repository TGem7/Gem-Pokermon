        ...
        Joker = {
            ...
            j_Gem_mega_sceptile = {
                ...
                text = {
                    ...
                    "Played {C:attention}Nature{} cards earn {C:money}$#1#{} when scored for",
                    "each {X:grass,C:white}Grass{} card you have",
                    "{C:inactive,s:0.8}(includes Jokers and Energy cards){}",
                } 
            },
            j_Gem_torchic = {
            ...
            j_Gem_joltik = {
                ...
                text = {
                  ...
                  "Turns one {C:attention}Hazard Card{} held in hand",
                  "to a {C:attention}Gold Card{} at end of round",
            ...
            j_Gem_galvantula = {
                ...
                text = {
                  "{C:purple}+#1# Hazards {C:inactive}(1 per #2# cards)",
                  "Turns every third {C:attention}Hazard Card{} held in hand",
                  "to a {C:attention}Gold Card{} at end of round",
                }
            },
            j_Gem_cubone = {
            ...
            j_Gem_pincurchin = {
                name = "Pincurchin",
                text = {
                    "When sold, create a Negative {C:pink}Lightning Energy{} card",
                    "for each {X:lightning, C:black}Lightning{} Joker you have",
                }
            },
            j_Gem_indeedee_f = {
                name = "Indeedee F",
                text = {
                    "When sold, create a Negative {C:pink}Psychic Energy{} card",
                    "for each {X:psychic,C:white}Psychic{} Joker you have",
                }
            },
            j_Gem_indeedee_m = {
                name = "Indeedee M",
