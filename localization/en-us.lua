return {
    descriptions = {
        Item = {
            ...
            c_Gem_scrollofdarkness = {
                name = "Scroll of Darkness",
                text = {
                    "Evolves Kubfu!",
                },
            },
            c_Gem_scrollofwaters = {
        ...
        Joker = {
            ...
            j_Gem_sizzlipede = {
                name = "Sizzlipede",
                text = {
                    "Gains {C:mult}+#2#{} Mult if {C:attention}scoring hand{}",
            ...
            j_Gem_urshifu_rapid_strike = {
                ...
                text = {
                    ...
                    "cards instead gain half of",
                    "those chips permanently",
            ...
            j_Gem_wailmer = {
                ...
                text = {
                    ...
                    "{C:attention}hand{} contains {C:attention}5 cards{}",
                    "{C:inactive}(Evolves after {C:attention}#2#{C:inactive} rounds)",
                }
            },
            j_Gem_wailord = {
                name = "Wailord",
                text = {
                    "{C:chips}+#1# Chips{} if {C:attention}scoring hand{}",
                    "contains {C:attention}5 cards{}",
                    "{br:4}ERROR - CONTACT STEAK",
            ...
            j_Gem_cutiefly = {
                ...
                text = {
                    ...
                    "{C:inactive}(Evolves after",
                    "{C:inactive}triggering {C:attention,s:0.8}#2#{C:inactive,s:0.8} times)",
                }
            },
            j_Gem_ribombee = {
                name = "Ribombee",
